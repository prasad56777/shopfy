        ...
        let kindablock = document.getElementById('kindablock')
        ...
        function dynamicCartSection(ob,itemCounter)
        {
            ...
            kindablock.appendChild(boxContainerDiv)
            kindablock.appendChild(totalContainerDiv)
            // let cartMain = document.createElement('div')
            // cartmain.id = 'checkout'
        ...
        buttonLink.href = '/OrderConfirmation.html?'
